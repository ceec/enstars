...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4">
                <h2 class="pull-right">
                    <a href="/graph/five-star-history/basic">Basic</a> | <a
                            href="/graph/five-star-history/music">Music</a> | <a
                            href="/graph/five-star-history/classic">Classic</a>
                </h2>
            </div>
        </div>
        <div class="row">
                        ...
                        <tr>
                            ...
                            @foreach($boy->cards()->where('stars','=','5')->where('game_id','=',$game)->get() as $card)
                                ...
                                @if(isset($card->event))
                                    <td>
                                        <a href="/card/{{$card->id}}">
                                            <button class="btn {{$button_class}}">{{$card->eventcard->type}}</button>
                                        </a>
                                        <br>
                                ...
                                @elseif(isset($card->scout))
                                    <td>
                                        <a href="/card/{{$card->id}}">
                                            <button class="btn {{$button_class}}">Scout</button>
                                        </a>
                                ...
                                @else
                                    <td>
                                        <a href="/card/{{$card->id}}">
                                            <button class="btn {{$button_class}}">Base Set</button>
                                        </a>
                                        <br>
