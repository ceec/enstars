                ...
                @if (!Auth::guest())
                    @if (Auth::user()->role_id == 1)
                      <div class="panel panel-info">
                        <div class="panel-heading">
                          <h3 class="panel-title">Card Suggestion</h3>
                        </div>
                        <div class="panel-body">
                      @if(!isset($card_suggestion->id))
                          <p>
                            Have this card and some of its data is missing from the database? Add it with suggestions!
                          </p>
                          {!! Form::open(['url' => '/add/cardsuggestion']) !!}
                          {!! Form::hidden('acard_id', $card->id) !!}                                                      
                          {!! Form::submit('Add Suggestion') !!}
                          {!! Form::close() !!}  
                      @else
                          {!! Form::open(['url' => '/edit/cardsuggestion']) !!}
                            <div class="row">
                              <div class="col-md-6">
                                  <div class="form-group form-inline">
                                    <label for="japanese-name">Japanese Name</label>
                                     {!! Form::text('japanese_name',$card_suggestion->name_j,['class'=>'form-control','id'=>'japanese-name','maxlength'=>'255']) !!}
                                  </div> 
                                  <div class="form-group form-inline">
                                    <label for="english-name">English Name</label>
                                     {!! Form::text('english_name',$card_suggestion->name_e,['class'=>'form-control','id'=>'english-name','maxlength'=>'255']) !!}
                                  </div>
                                  <div class="form-group form-inline">
                                    <label for="sentence-j">Japanese Sentence (when scouted or on promo materials)</label>
                                     {!! Form::text('sentence_j',$card_suggestion->sentence_j,['class'=>'form-control','id'=>'sentence-j','maxlength'=>'255']) !!}
                                  </div>  
                                  <div class="form-group form-inline">
                                    <label for="sentence-e">English Sentence (when scouted or on promo materials)</label>
                                     {!! Form::text('sentence_e',$card_suggestion->sentence_e,['class'=>'form-control','id'=>'sentence-e','maxlength'=>'255']) !!}
                                  </div>                                                                                                        
                              </div>
                              <div class="col-md-3">
                                <div class="form-group form-inline">
                                    <label for="stars">Stars</label>
                                     {!! Form::number('stars',$card_suggestion->stars,['class'=>'form-control','id'=>'stars','min'=>'1','max'=>'5']) !!}
                                  </div>  
                                <div class="form-group form-inline">
                                    <label for="stars">Color</label>
                                      {!! Form::select('color', array('red' => 'Dance', 'blue' => 'Vocal','yellow'=>'Performance'), $card_suggestion->color,['class'=>'form-control','id'=>'color']) !!}
                                  </div>
                                <div class="form-group form-inline">
                                    <label for="da">Da</label>
                                     {!! Form::number('da',$card_suggestion->da,['class'=>'form-control','id'=>'da','max'=>'100000000']) !!}
                                  </div>
                                <div class="form-group form-inline">
                                    <label for="vo">Vo</label>
                                     {!! Form::number('vo',$card_suggestion->vo,['class'=>'form-control','id'=>'vo','max'=>'100000000']) !!}
                                  </div>
                                <div class="form-group form-inline">
                                    <label for="pf">Pf</label>
                                     {!! Form::number('pf',$card_suggestion->pf,['class'=>'form-control','id'=>'pf','max'=>'100000000']) !!}
                                  </div>                                 
                              </div>
                              <div class="col-md-3">
                                <div class="form-group form-inline">
                                    <label for="da_max">Da Max - 1 Card</label>
                                     {!! Form::number('da_max',$card_suggestion->da_max,['class'=>'form-control','id'=>'da_max','max'=>'100000000']) !!}
                                  </div>
                                <div class="form-group form-inline">
                                    <label for="vo_max">Vo Max - 1 Card</label>
                                     {!! Form::number('vo_max',$card_suggestion->vo_max,['class'=>'form-control','id'=>'vo_max','max'=>'100000000']) !!}
                                  </div>
                                <div class="form-group form-inline">
                                    <label for="pf_max">Pf Max - 1 Card</label>
                                     {!! Form::number('pf_max',$card_suggestion->pf_max,['class'=>'form-control','id'=>'pf_max','max'=>'100000000']) !!}
                                  </div>   
                                <div class="form-group form-inline">
                                    <label for="da_max5">Da Max - 5 Cards</label>
                                     {!! Form::number('da_max5',$card_suggestion->da_max5,['class'=>'form-control','id'=>'da_max5','max'=>'100000000']) !!}
                                  </div>
                                <div class="form-group form-inline">
                                    <label for="vo_max5">Vo Max - 5 Cards</label>
                                     {!! Form::number('vo_max5',$card_suggestion->vo_max5,['class'=>'form-control','id'=>'vo_max5','max'=>'100000000']) !!}
                                  </div>
                                <div class="form-group form-inline">
                                    <label for="pf_max5">Pf Max - 5 Cards</label>
                                     {!! Form::number('pf_max5',$card_suggestion->pf_max5,['class'=>'form-control','id'=>'pf_max5','max'=>'100000000']) !!}
                                  </div>                                                                    
                              </div>                              
                            </div>
                              <hr>
                                ...
                                <div class="col-md-6">
                                  <div class="form-group form-inline">
                                    <label for="dorifes_j">Japanese Dorifes Skill </label>
                                     {!! Form::text('dorifes_j',$card_suggestion->dorifes_j,['class'=>'form-control','id'=>'dorifes_j','maxlength'=>'255']) !!}
                                  </div>  
                                  <div class="form-group form-inline">
                                    <label for="dorifes_e">English Dorifes Skill</label>
                                     {!! Form::text('dorifes_e',$card_suggestion->dorifes_e,['class'=>'form-control','id'=>'dorifes_e','maxlength'=>'255']) !!}
                                  </div>      
                                  <div class="form-group form-inline">
                                    <label for="lesson_j">Japanese Lesson Skill </label>
                                     {!! Form::text('lesson_j',$card_suggestion->lesson_j,['class'=>'form-control','id'=>'lesson_j','maxlength'=>'255']) !!}
                                  </div>  
                                  <div class="form-group form-inline">
                                    <label for="lesson_e">English Lesson Skill</label>
                                     {!! Form::text('lesson_e',$card_suggestion->lesson_e,['class'=>'form-control','id'=>'lesson_e','maxlength'=>'255']) !!}
                                  </div>                                    
                                </div>
                                <div class="col-md-6">
                                  <div class="form-group form-inline">
                                    <label for="dorifes-id">Dream Festival Skill</label>
                                    {!! Form::select('dorifes_id', $dorifes_skills,$card_suggestion->dorifes_id,['class'=>'form-control', 'id'=>'dorifes-id','placeholder' => 'Dream Festival Skill']) !!} 
                                  </div>                                                                                                                                      
                                  <div class="form-group form-inline">
                                    <label for="lesson-skill">Lesson Skill</label>
                                    {!! Form::select('lesson_id', $lesson_skills,$card_suggestion->lesson_id ,['class'=>'form-control', 'id'=>'lesson-skill','placeholder' => 'Lesson Skill']) !!} 
                                  </div>                                   
                                </div>
                              </div>
                              <hr>
                                ...
                                <div class="col-md-6">
                                  <div class="form-group form-inline">
                                    <label for="u_dorifes_j">Japanese Dorifes Skill </label>
                                     {!! Form::text('u_dorifes_j',$card_suggestion->u_dorifes_j,['class'=>'form-control','id'=>'u_dorifes_j','maxlength'=>'255']) !!}
                                  </div>  
                                  <div class="form-group form-inline">
                                    <label for="u_dorifes_e">English Dorifes Skill</label>
                                     {!! Form::text('u_dorifes_e',$card_suggestion->u_dorifes_e,['class'=>'form-control','id'=>'u_dorifes_e','maxlength'=>'255']) !!}
                                  </div>      
                                  <div class="form-group form-inline">
                                    <label for="u_lesson_j">Japanese Lesson Skill </label>
                                     {!! Form::text('u_lesson_j',$card_suggestion->u_lesson_j,['class'=>'form-control','id'=>'u_lesson_j','maxlength'=>'255']) !!}
                                  </div>  
                                  <div class="form-group form-inline">
                                    <label for="u_lesson_e">English Lesson Skill</label>
                                     {!! Form::text('u_lesson_e',$card_suggestion->u_lesson_e,['class'=>'form-control','id'=>'u_lesson_e','maxlength'=>'255']) !!}
                                  </div>                                    
                                </div>
                                <div class="col-md-6">
                                  <div class="form-group form-inline">
                                    <label for="u_dorifes-id">Dream Festival Skill</label>
                                    {!! Form::select('u_dorifes_id', $dorifes_skills,$card_suggestion->u_dorifes_id,['class'=>'form-control', 'id'=>'u_dorifes-id','placeholder' => 'Dream Festival Skill']) !!} 
                                  </div>                                                                                                                                      
                                  <div class="form-group form-inline">
                                    <label for="u_lesson-skill">Lesson Skill</label>
                                    {!! Form::select('u_lesson_id', $lesson_skills,$card_suggestion->u_lesson_id ,['class'=>'form-control', 'id'=>'u_lesson-skill','placeholder' => 'Lesson Skill']) !!} 
                                  </div>                                   
                                </div>
                              </div>                                                     
                          {!! Form::hidden('suggestion_id', $card_suggestion->id) !!}                                                
                          {!! Form::hidden('acard_id', $card->id) !!}                                                      
                          {!! Form::submit('Edit') !!}
                          {!! Form::close() !!}                              
                      @endif
