            ...
            @if (Auth::user()->isAdmin())
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Admin - Edit Collaboration {{$collaboration->id}}<span
                                    class="pull-right">Last Updated on {{$collaboration->updated_at}} by {{$collaboration->name}} </span>
                        </h3>
                    </div>
