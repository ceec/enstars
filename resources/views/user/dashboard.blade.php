                    ...
                    <div class="col-md-9">
                        <div class="row">
                            ...
                            <p style="font-size:15px">
                                ...
                                <p>When you are logged into an account all cards on the boy card list pages get a new
                                    Add button. Click on it to add the card to your collection!</p>
                                <h3>Updating card stats</h3>
                                <p>Once the card is in your collection, tracking features for that card are available on
                                    each card's page. Add in how many copies you have any other stats!</p>
                                <h3>How to share your collection</h3>
                                <p>The <a href="/collection/{{Auth::user()->name}}">Collection</a> is viewable to
                                    anyone, no account needed. Use it to share your collection with others.</p>
                                <p>Want to keep your collection private? You can change the visibility of your
                                    collection in Account Options.</p>
                            </div>
                        </div>
                    </div>
                </div>
