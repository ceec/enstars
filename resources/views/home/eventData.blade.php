...
<div class="container">
    <div class="row">
    	...
    	<div class="col-md-6">
            ...
            {!! Form::text('rank_2', '2000',['class'=>'']) !!} {!! Form::text('tier_2', '',['class'=>'',  'placeholder'=>'Rank 2 Points']) !!} <br>
            ...
            {!! Form::text('rank_10', '28000',['class'=>'']) !!} {!! Form::text('tier_10', '',['class'=>'',  'placeholder'=>'Rank 10 Points']) !!} <br>
            {!! Form::text('rank_11', '35000',['class'=>'']) !!} {!! Form::text('tier_11', '',['class'=>'',  'placeholder'=>'Rank 11 Points']) !!} <br>
